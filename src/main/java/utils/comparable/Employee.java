...
public class Employee implements Comparable<Employee> {
   ...
   * @return A negative integer, zero, or a positive integer as this employee is less than, equal
   *         to, or greater than the supplied employee object.
   */
  @Override
